...
foods.forEach(food => {
  ...
  item.innerHTML = `
        <div><img class="hinhanh" src ="${food.image}"></div> 
        <div class="container">
        <div class="container-items"> <h3>${food.name}</h3></div>
    </div>
    <div class="container">
        <div class="container-items"> <b>${food.price}</b> </div>
        ...
        <div class="container-items"><b>Chi tiết</b></div>
  `
  menuDisplay.firstElementChild.appendChild(item);
});